...
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      const o = n(17);
      const i = n(5);
      const s = {'Content-Type': 'application/x-www-form-urlencoded'};
      function a(e, t) {
        !r.isUndefined(e) &&
        ...
        return new Promise(function (t, n) {
          ...
          if (
            ...
            (g.ontimeout = function () {
              let t = e.timeout
                ...
                : 'timeout exceeded';
              const r = e.transitional || l.transitional;
          ...
          'setRequestHeader' in g &&
            r.forEach(m, function (e, t) {
              void 0 === h && t.toLowerCase() === 'content-type'
                ? delete m[t]
                : g.setRequestHeader(t, e);
            }),
            r.isUndefined(e.withCredentials) ||
              (g.withCredentials = !!e.withCredentials),
            v && v !== 'json' && (g.responseType = e.responseType),
      ...
      (o.transitional = function (e, t, n) {
        ...
        (e.exports = {
          assertOptions(e, t, n) {
            ...
            for (let r = Object.keys(e), o = r.length; o-- > 0; ) {
              const i = r[o];
              const s = t[i];
              if (s) {
                const a = e[i];
                const u = void 0 === a || s(a, i, e);
                if (!0 !== u) {
