...
export default function API(network, args) {
  ...
  function performPOSTRequest(
    ...
    const finalApiDeferred = new KirokuAPIDeferred(
  ...
  function requireParameters(parameterNames, parameters, commandName) {
    parameterNames.forEach(parameterName => {
      if (
        ...
        throw new Error(
          `Parameter ${parameterName} is required for "${commandName}". Supplied parameters: ${keys}`,
        );
      }
    });
  }
  ...
  return {
    ...
    expensiworks: {
      ...
      processJob(parameters) {
        ...
        requireParameters(
          ['jobID', 'jobName', 'answers', 'duration'],
          parameters,
          commandName,
        );
        return performPOSTRequest(commandName, parameters);
    ...
    card: {
      ...
      setLimit(parameters) {
        ...
        requireParameters(
          ['cardUserEmail', 'hasCustomLimit', 'domainName'],
          parameters,
          commandName,
        );
        return performPOSTRequest(commandName, parameters);
