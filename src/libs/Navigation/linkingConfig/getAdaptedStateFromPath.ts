...
//   > = [{name: SCREENS.HOME, params: {policyID}}];
...
// function createCentralPaneNavigator(
//   route: NavigationPartialRoute<CentralPaneName>,
// ): NavigationPartialRoute<typeof NAVIGATORS.CENTRAL_PANE_NAVIGATOR> {
//   return {
...
// function createFullScreenNavigator(
//   route: NavigationPartialRoute<FullScreenName>,
// ): NavigationPartialRoute<typeof NAVIGATORS.FULL_SCREEN_NAVIGATOR> {
//   const routes = [];
...
// ):
//   | NavigationPartialRoute<
//       | typeof NAVIGATORS.CENTRAL_PANE_NAVIGATOR
//       | typeof NAVIGATORS.FULL_SCREEN_NAVIGATOR
//     >
//   | undefined {
...
//       return createCentralPaneNavigator({
...
//   for (const [fullScreenName, RHPNames] of Object.entries(
//     FULL_SCREEN_TO_RHP_MAPPING,
//   )) {
//     if (RHPNames && RHPNames.includes(route.name)) {
//       return createFullScreenNavigator({
//         name: fullScreenName as FullScreenName,
//         params: route.params,
//       });
//     }
//   }
...
//   );
//   const centralPaneNavigator = state.routes.find(
//     route => route.name === NAVIGATORS.CENTRAL_PANE_NAVIGATOR,
//   );
//   const fullScreenNavigator = state.routes.find(
...
//     if (topmostNestedRHPRoute) {
//       let matchingRootRoute = getMatchingRootRouteForRHPRoute(
//         topmostNestedRHPRoute,
//       );
