      ...
      <View style={styles.RHPNavigatorContainer(isSmallScreenWidth)}>
        <Stack.Navigator screenOptions={screenOptions}>
          ...
          <Stack.Screen
            ...
            component={
              ModalStackNavigators.ReportDescriptionModalStackNavigator
            }
          />
          <Stack.Screen
          ...
          <Stack.Screen
            ...
            component={
              ModalStackNavigators.OnboardEngagementModalStackNavigator
            }
          />
          <Stack.Screen
          ...
          <Stack.Screen
            ...
            component={
              ModalStackNavigators.ProcessMoneyRequestHoldStackNavigator
            }
          />
        </Stack.Navigator>
      </View>
