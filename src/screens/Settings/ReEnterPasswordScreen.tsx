...
function ReEnterPasswordScreen({}: ReEnterPasswordScreenProps) {
  return (
    <ScreenWrapper testID="testsomething">
...
//       IOU.setDraftSplitTransaction(transaction?.transactionID ?? '-1', {
//         comment: newComment,
//       });
//       navigateBack();
//       return;
...
//   const reportAction =
//     reportActions?.[report?.parentReportActionID || reportActionID] ?? null;
//   const isEditing = action === CONST.IOU.ACTION.EDIT;
//   const isSplitBill = iouType === CONST.IOU.TYPE.SPLIT;
//   const canEditSplitBill =
//     isSplitBill &&
//     reportAction &&
//     session?.accountID === reportAction.actorAccountID &&
...
//         !ReportUtils.canEditMoneyRequest(reportAction));
//   const isReportInGroupPolicy =
//     !!report?.policyID && report.policyID !== CONST.POLICY.ID_FAKE;
