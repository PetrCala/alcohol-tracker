...
type GetReportActionContextMenuStylesStyleUtil = {
 ...
 * @param theme
 */
const createReportActionContextMenuStyleUtils: StyleUtilGenerator<
  GetReportActionContextMenuStylesStyleUtil
> = ({theme, styles}) => ({
