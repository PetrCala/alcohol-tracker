...
import personalDetailsPropType from '@screens/personalDetailsPropType';
...
export default function <
  TProps extends WithCurrentUserPersonalDetailsProps,
  TRef,
>(
  WrappedComponent: ComponentType<TProps & RefAttributes<TRef>>,
): ComponentType<Omit<TProps, keyof HOCProps> & RefAttributes<TRef>> {
  function WithCurrentUserPersonalDetails(
