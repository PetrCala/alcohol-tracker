...
// function getInitialCurrentDateView(
//   value: Date | string,
//   minDate: Date,
//   maxDate: Date,
// ) {
//   let initialCurrentDateView =
...
//     getInitialCurrentDateView(value, minDate, maxDate),
//   );
...
//     Array.from({length: maxYear - minYear + 1}, (v, i) => i + minYear).map(
//       year => ({
//         text: year.toString(),
//         value: year,
...
//       onSelected?.(
//         format(new Date(newCurrentDateView), CONST.DATE.FNS_FORMAT_STRING),
//       );
//       return newCurrentDateView;
//     });
//   };
...
//   const calendarDaysMatrix = generateMonthMatrix(
//     currentYearView,
//     currentMonthView,
//   );
//   const hasAvailableDatesNextMonth =
//     startOfDay(new Date(maxDate)) > endOfMonth(new Date(currentDateView));
//   const hasAvailableDatesPrevMonth =
//     endOfDay(new Date(minDate)) < startOfMonth(new Date(currentDateView));
...
//         <View key={`week-${week.toString()}`} style={themeStyles.flexRow}>
//           {week.map((day, index) => {
...
//                 new Date(currentYearView, currentMonthView, day),
//               );
//             const handleOnPress = () => {
//               if (!day) {
//                 return;
