...
//   BaseTextInputProps,
//   BaseTextInputRef,
// } from './TextInput/BaseTextInput/types';
...
//   'hideCurrencySymbol' | 'extraSymbol'
// > &
...
//       (event.nativeEvent?.target as HTMLElement | null)?.id ?? '';
...
//       const newAmountWithoutSpaces =
//         MoneyRequestUtils.stripSpacesFromAmount(newAmount);
//       // Use a shallow copy of selection to trigger setSelection
//       // More info: https://github.com/Expensify/App/issues/16385
//       if (
//         !MoneyRequestUtils.validateAmount(
...
//       const strippedAmount = MoneyRequestUtils.stripCommaFromAmount(
//         newAmountWithoutSpaces,
//       );
//       const isForwardDelete =
//         currentAmount.length > strippedAmount.length &&
//         forwardDeletePressedRef.current;
//       setSelection(
//         getNewSelection(
//           selection,
//           isForwardDelete ? strippedAmount.length : currentAmount.length,
//           strippedAmount.length,
//         ),
//       );
...
//     // More info: https://github.com/Expensify/App/issues/16974
//     const newAmountWithoutSpaces =
//       MoneyRequestUtils.stripSpacesFromAmount(text);
//     const replacedCommasAmount = MoneyRequestUtils.replaceCommasWithPeriod(
//       newAmountWithoutSpaces,
//     );
//     const withLeadingZero =
//       MoneyRequestUtils.addLeadingZero(replacedCommasAmount);
...
//     const strippedAmount =
//       MoneyRequestUtils.stripCommaFromAmount(withLeadingZero);
//     const isForwardDelete =
//       currentAmount.length > strippedAmount.length &&
//       forwardDeletePressedRef.current;
//     setSelection(
...
//     if (
//       MoneyRequestUtils.validateAmount(currentAmount, decimals, amountMaxLength)
//     ) {
//       return;
//     }
...
//         return;
//       }
//       const newAmount = MoneyRequestUtils.addLeadingZero(
//         `${currentAmount.substring(0, selection.start)}${key}${currentAmount.substring(selection.end)}`,
//       );
...
//       key === CONST.PLATFORM_SPECIFIC_KEYS.CTRL.DEFAULT
//     ) {
...
//     forwardDeletePressedRef.current =
//       key === 'delete' ||
//       (allowedOS.includes(operatingSystem ?? '') &&
//         event.nativeEvent.ctrlKey &&
//         key === 'd');
//   };

//   const formattedAmount = MoneyRequestUtils.replaceAllDigits(
//     currentAmount,
//     toLocaleDigit,
//   );
...
//         style={[
//           styles.moneyRequestAmountContainer,
//           styles.flex1,
//           styles.flexRow,
//           styles.w100,
...
//               styles.pAbsolute,
//               styles.b0,
//               canUseTouchScreen ? styles.mb0 : styles.mb3,
//               styles.ph5,
//               styles.w100,
//             ]}
//             isError
...
//         <View
//           onMouseDown={event =>
//             focusTextInput(event, [NUM_PAD_CONTAINER_VIEW_ID, NUM_PAD_VIEW_ID])
//           }
//           style={[
//             styles.w100,
