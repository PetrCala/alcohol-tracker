...
//     Navigation.navigate(
//       ROUTES.SEARCH_REPORT.getRoute(transactionItem.transactionThreadReportID),
//     );
//   };
...
//   const participantFromDisplayName =
//     participantFrom?.displayName ?? participantFrom?.login ?? '';
//   const participantToDisplayName =
//     participantTo?.displayName ?? participantTo?.login ?? '';
...
//         onCheckboxPress={() =>
//           onCheckboxPress?.(transactionItem as unknown as TItem)
//         }
...
//             ]}>
//             <View
//               style={[styles.flexRow, styles.alignItemsCenter, styles.flex2]}>
//               {canSelectMultiple && (
//                 <Checkbox
...
//               )}
//               <View
//                 style={[styles.flexShrink1, isLargeScreenWidth && styles.ph4]}>
//                 <Text style={[styles.reportListItemTitle]}>
//                   {reportItem?.reportName}
//                 </Text>
//               </View>
//             </View>
//             <View
//               style={[styles.flexRow, styles.flex1, styles.justifyContentEnd]}>
//               <TotalCell
//                 showTooltip={showTooltip}
...
//           {isLargeScreenWidth && (
//             <View
//               style={StyleUtils.getSearchTableColumnStyles(
...
//             containerStyle={[
//               transaction.isSelected && styles.activeComponentBG,
//               styles.ph3,
//               styles.pv1half,
//             ]}
//             isChildListItem
