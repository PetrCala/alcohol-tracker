...
//   const shouldUseViewAction =
//     action === CONST.SEARCH.ACTION_TYPES.VIEW ||
//     (parentAction === CONST.SEARCH.ACTION_TYPES.PAID &&
//       action === CONST.SEARCH.ACTION_TYPES.PAID);
...
//       <View
//         style={[
//           StyleUtils.getHeight(variables.h28),
...
//             isSelected
//               ? StyleUtils.getBorderColorStyle(theme.buttonHoveredBG)
