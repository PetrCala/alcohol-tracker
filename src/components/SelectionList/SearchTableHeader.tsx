...
//     shouldShow: (data: OnyxTypes.SearchResults['data']) =>
//       SearchUtils.getShouldShowMerchant(data),
//   },
//   {
...
//     shouldShow: (data, metadata) =>
//       metadata?.columnsToShow?.shouldShowCategoryColumn ?? false,
//   },
//   {
//     columnName: CONST.SEARCH.TABLE_COLUMNS.TAG,
//     translationKey: 'common.tag',
//     shouldShow: (data, metadata) =>
//       metadata?.columnsToShow?.shouldShowTagColumn ?? false,
//   },
//   {
//     columnName: CONST.SEARCH.TABLE_COLUMNS.TAX_AMOUNT,
//     translationKey: 'common.tax',
//     shouldShow: (data, metadata) =>
//       metadata?.columnsToShow?.shouldShowTaxColumn ?? false,
//     isColumnSortable: false,
//   },
//   {
...
//         {expenseHeaders.map(
//           ({columnName, translationKey, shouldShow, isColumnSortable}) => {
...
//             const textStyle =
//               columnName === CONST.SEARCH.TABLE_COLUMNS.RECEIPT
//                 ? StyleUtils.getTextOverflowStyle('clip')
//                 : null;
