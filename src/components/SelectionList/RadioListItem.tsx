...
function RadioListItem<TItem extends ListItem>({
  ...
  const paddingLeft =
    Math.floor(indentsLength / CONST.INDENTS.length) * styles.ml3.marginLeft;
  const alternateTextMaxWidth =
    variables.sideBarWidth -
    styles.ph5.paddingHorizontal * 2 -
    styles.ml3.marginLeft -
            ...
            <TextWithTooltip
              ...
              style={[
                ...
                isAlternateTextMultilineSupported
                  ? {maxWidth: alternateTextMaxWidth}
                  : null,
              ]}
