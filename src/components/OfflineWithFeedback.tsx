...
function OfflineWithFeedback({
  ...
  const isAddError =
    hasErrors && pendingAction === CONST.RED_BRICK_ROAD_PENDING_ACTION.ADD;
  const needsOpacity =
        ...
        <View
          style={[
            needsOpacity
              ...
              : styles.offlineFeedback.default,
            contentContainerStyle,
          ]}
          needsOffscreenAlphaCompositing={
            shouldRenderOffscreen
              ? needsOpacity && needsOffscreenAlphaCompositing
              : undefined
          }>
          <CustomStylesForChildrenProvider
            style={
              needsStrikeThrough
