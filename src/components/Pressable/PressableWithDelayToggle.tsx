...
function PressableWithDelayToggle(
  {
    iconChecked = KirokuIcons.Checkmark,
    inline = true,
    onPress,
    text,
    textChecked,
  ...
  const labelText = (
    <Text suppressHighlighting style={textStyles}>
  ...
  return (
    <PressableView
      ...
      <>
        {inline && labelText}
        <Tooltip text={tooltipTexts} shouldRender>
                ...
                {icon && (
                  <Icon
                    ...
                    fill={StyleUtils.getIconFillColor(
                      getButtonState(hovered, pressed, !isActive),
                    )}
