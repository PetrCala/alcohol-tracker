...
import {Close} from './Icon/KirokuIcons';
      ...
      <View style={[styles.m5, contentStyles]}>
          ...
          <View style={styles.alignItemsEnd}>
            <Tooltip text={translate('common.close')}>
              <PressableWithoutFeedback
                ...
                <Icon fill={theme.icon} src={Close} />
              </PressableWithoutFeedback>
            </Tooltip>
          </View>
        )}
        <View style={isCentered ? [styles.alignItemsCenter, styles.mb6] : []}>
          {iconSource && (
            <View
              style={[
                shouldCenterIcon ? styles.justifyContentCenter : null,
                styles.flexRow,
                styles.mb3,
              ]}>
              <Icon
          ...
          <View
            style={[
              styles.flexRow,
              isCentered ? {} : styles.mb4,
              titleContainerStyles,
            ]}>
            <Header title={title} textStyles={titleStyles} />
          </View>
          {typeof prompt === 'string' ? (
            <Text
              style={[promptStyles, isCentered ? styles.textAlignCenter : {}]}>
              {prompt}
            </Text>
          ) : (
            prompt
