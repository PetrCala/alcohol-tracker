...
function SubscriptAvatar({
  ...
  const subscriptStyle =
    size === CONST.AVATAR_SIZE.SMALL_NORMAL
      ? styles.secondAvatarSubscriptSmallNormal
        ...
        <View>
          <Avatar
            containerStyles={StyleUtils.getWidthAndHeightStyle(
              StyleUtils.getAvatarSize(size || CONST.AVATAR_SIZE.DEFAULT),
            )}
        ...
        <UserDetailsTooltip
          ...
          <View
            style={[
              ...
              isSmall ? styles.secondAvatarSubscriptCompact : subscriptStyle,
            ]}
            ...
            <Avatar
              iconAdditionalStyles={[
                StyleUtils.getAvatarBorderWidth(
                  isSmall
                    ? CONST.AVATAR_SIZE.SMALL_SUBSCRIPT
                    : CONST.AVATAR_SIZE.SUBSCRIPT,
                ),
                StyleUtils.getBorderColorStyle(
