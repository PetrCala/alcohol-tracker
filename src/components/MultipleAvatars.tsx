...
type AvatarSizeToStyles =
  | typeof CONST.AVATAR_SIZE.SMALL
  | typeof CONST.AVATAR_SIZE.LARGE
  | typeof CONST.AVATAR_SIZE.DEFAULT;
...
function MultipleAvatars({
  ...
  const secondAvatarStyle = secondAvatarStyleProp ?? [
    StyleUtils.getBackgroundAndBorderStyle(
      isHovered ? theme.activeComponentBG : theme.componentBG,
    ),
  ];

  let avatarContainerStyles = StyleUtils.getContainerStyles(
    size,
    isInReportAction,
  );
  const {singleAvatarStyle, secondAvatarStyles} = useMemo(
    () =>
      avatarSizeToStylesMap[size as AvatarSizeToStyles] ??
      avatarSizeToStylesMap.default,
  ...
  const oneAvatarBorderWidth =
    StyleUtils.getAvatarBorderWidth(size).borderWidth ?? 0;
      ...
      <View
          ...
          <UserDetailsTooltip
            ...
            <View
              style={[
                ...
                StyleUtils.getAvatarBorderRadius(size, icon.type),
              ]}>
              <Avatar
        ...
        {avatars.length > maxAvatarsInRow && (
          <Tooltip
            ...
            text={tooltipTexts
              .slice(
                avatarRows.length * maxAvatarsInRow - 1,
                avatarRows.length * maxAvatarsInRow + 9,
              )
              .join(', ')}>
            <View
              style={[
                ...
                StyleUtils.getHorizontalStackedOverlayAvatarStyle(
                  oneAvatarSize,
                  oneAvatarBorderWidth,
                ),
              ]}>
              <View
                style={[
                ...
                <Text
                  style={[
                    ...
                    StyleUtils.getAvatarExtraFontSizeStyle(size),
