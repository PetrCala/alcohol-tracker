  ...
  return (
    <View style={[styles.alignItemsCenter, containerStyle]}>
      ...
      <View
        ...
        <View
          style={[styles.shortTermsHorizontalRule, styles.flex1, styles.mr0]}
        />
        <Button
          style={styles.mh0}
          small
          shouldShowRightIcon
          iconFill={theme.icon}
          iconRight={KirokuIcons.DownArrow}
          text={translate('common.showMore')}
          accessibilityLabel={translate('common.showMore')}
          onPress={onPress}
        />
        <View
          style={[styles.shortTermsHorizontalRule, styles.flex1, styles.ml0]}
        />
      </View>
    </View>
  );
