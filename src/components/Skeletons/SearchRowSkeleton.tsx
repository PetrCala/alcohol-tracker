        ...
        <ItemListSkeletonView
          ...
          renderSkeletonItem={() => (
            <>
              ...
              <Rect x={40} y={24} width={40} height={4} />
              <Circle cx={96} cy={26} r={8} />

              <Rect x={112} y={24} width={40} height={4} />
              <Rect
                x={windowWidth - 130}
                y={12}
                width={80}
              ...
              <Rect x={16} y={56} width={36} height={40} rx={4} ry={4} />
              <Rect x={64} y={65} width={124} height={8} />
              <Rect x={64} y={79} width={60} height={8} />
              <Rect x={windowWidth - 130} y={65} width={80} height={8} />
              <Rect x={windowWidth - 110} y={79} width={60} height={8} />
            </>
          )}
        />
      </View>
  ...
  return (
    <View style={[styles.flex1, containerStyle]}>
      <ItemListSkeletonView
        ...
        renderSkeletonItem={() => (
          <>
            <Rect x={12} y={12} rx={5} ry={5} width={36} height={40} />
            <Rect x={60} y={28} width={30} height={barHeight} />
            <Rect x={102} y={28} width={longBarWidth} height={barHeight} />
            {isLargeScreenWidth && (
              <>
                <Rect x={234} y={28} width={longBarWidth} height={barHeight} />

                <Rect x={366} y={28} width={60} height={barHeight} />
              </>
            )}
