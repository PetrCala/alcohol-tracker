...
function assertCLAJobExecuted(
    ...
    createStepAssertion(
      ...
      [
        {key: 'text', value: commentBody},
        {
          key: 'regex',
          value:
            '\\s*I have read the CLA Document and I hereby sign the CLA\\s*',
        },
      ],
      [],
    ),
  ...
  const assistantSteps = [
    createStepAssertion(
      ...
      'CLA Assistant',
      [
        {key: 'path-to-signatures', value: `signatures/Kiroku/cla.json`},
        {
          key: 'path-to-document',
          value: `https://github.com/${githubRepository}/blob/master/contributingGuides/CLA.md`,
        },
