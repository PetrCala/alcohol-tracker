...
describe('validateAppVersion', () => {
    ...
    it('validates build number correctly', () => {
        let olderBuildNumberResult = validateAppVersion(olderBuildNumber, newerBuildNumber);

        expect(olderBuildNumberResult.success).toBe(true);
    });

    it('validates version with lower build number correctly', () => {
        let newerVersionWithLowerBuildNumberResult = validateAppVersion(olderBuildNumber, newerVersionWithLowerBuildNumber);
